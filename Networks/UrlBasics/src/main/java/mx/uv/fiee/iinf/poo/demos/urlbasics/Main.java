...
public class Main extends JFrame {
    ...
    public static void main (String [] args) throws MalformedURLException, IOException, NullPointerException, InterruptedException {
        ...
        //
        URL url = new URL ("https://www.uv.mx:8080/usuarios.html?q=any&filename=book.pdf");
        ...
        //
        URL loremURL = new URL ("https://www.uv.mx/"); // creamos al objeto URL a partir de la dirección
...
//      **********************************************HttpClient***************************************
        String url_base = "https://drive.google.com/uc?export=download&id=1ch4fqcBSr43cOIqQ-AnDWWN-1fIRYi65";
...
//        }
        ...
        client.sendAsync (request, HttpResponse.BodyHandlers.ofString ())
                .thenApply (res -> {
                    ...
                    // extract content-disposition from response
                    var contentDidposition = headers.get("Content-Disposition");
                    var filename = contentDidposition.get(0).split ("filename=")[1];
                    System.out.println ("Filename: " + filename);

                    return res.body().toUpperCase(Locale.ROOT); // transforming response's body
                })
                .thenAccept (s -> {
                   myText.setText (s);
                });
